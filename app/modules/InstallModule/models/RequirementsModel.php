...
class RequirementsModel extends BaseModel
{
        public function check()
        {
            ...
            if (function_exists('exec'))
                ...
                $status[] = array('title' => 'Exec function', 'status' => false, 'error' => 'Missing exec function. You will not be able to use NetFileMan');

            if (extension_loaded('sqlite'))
                $status[] = array('title' => 'SQLite', 'status' => true);
            else
                $status[] = array('title' => 'SQLite', 'status' => false, 'error' => 'SQLite is not loaded. You will not be able to install NetFileMan');
            ...
            if (class_exists('dibi'))
                ...
                $status[] = array('title' => 'Dibi', 'status' => false, 'error' => 'Dibi is not present. You will not be able to isntall NetFileMan');
